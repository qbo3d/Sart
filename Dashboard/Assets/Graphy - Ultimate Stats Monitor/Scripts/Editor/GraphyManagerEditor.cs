...
namespace Tayx.Graphy
{
    ...
    internal class GraphyManagerEditor : Editor
    {
        ...
        private SerializedProperty m_monoRamColor2;
        private SerializedProperty m_monoRamColor3;
        ...
        private void OnEnable()
        {
            ...
            m_monoRamColor2 = serObj.FindProperty("m_monoRamColor2");
            m_monoRamColor3 = serObj.FindProperty("m_monoRamColor3");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_ramModuleInspectorToggle)
            {
                ...
                m_monoRamColor2.colorValue = EditorGUILayout.ColorField
                (
                    label: "- Mono2",
                    value: m_monoRamColor2.colorValue
                );

                m_monoRamColor3.colorValue = EditorGUILayout.ColorField
                (
                    label: "- Mono3",
                    value: m_monoRamColor3.colorValue
                );
