...
{
    public class G_RpmManager : MonoBehaviour, IMovable, IModifiableState
    {
        /* ----- TODO: ----------------------------
        ...
        [SerializeField] private GameObject m_rpmGraphGameObject = null;
        ...
        private G_RpmGraph m_rpmGraph = null;
        private G_RpmText m_rpmText = null;
        ...
        public void UpdateParameters()
        {
            ...
            m_rpmGraph.UpdateParameters();
            m_rpmText.UpdateParameters();
        ...
        private void Init()
        {
            ...
            m_rpmGraph = GetComponent<G_RpmGraph>();
            m_rpmText = GetComponent<G_RpmText>();
        ...
        {
            m_rpmGraph.enabled = active;
            m_rpmGraphGameObject.SetActive(active);
        }
