...
{
    public class G_RpmGraph : G_Graph
    {
        /* ----- TODO: ----------------------------
        ...
        [SerializeField] private int m_resolution = 150;
        ...
        private G_RpmMonitor m_rpmMonitor = null;
        ...
        {
            float allocatedMemory = m_rpmMonitor.AllocatedRpm;
            float reservedMemory = m_rpmMonitor.ReservedRpm;
            float monoMemory = m_rpmMonitor.MonoRpm;
        ...
        protected override void CreatePoints()
        {
            ...
            m_shaderGraphAllocated.GoodColor = m_allocatedRamColor;
            m_shaderGraphAllocated.CautionColor = m_allocatedRamColor;
            m_shaderGraphAllocated.CriticalColor = m_allocatedRamColor;

            m_shaderGraphAllocated.UpdateColors();

            m_shaderGraphReserved.GoodColor = m_reservedRamColor;
            m_shaderGraphReserved.CautionColor = m_reservedRamColor;
            m_shaderGraphReserved.CriticalColor = m_reservedRamColor;

            m_shaderGraphReserved.UpdateColors();

            m_shaderGraphMono.GoodColor = m_monoRamColor;
            m_shaderGraphMono.CautionColor = m_monoRamColor;
            m_shaderGraphMono.CriticalColor = m_monoRamColor;
        ...
        private void Init()
        {
            m_rpmMonitor = GetComponent<G_RpmMonitor>();
