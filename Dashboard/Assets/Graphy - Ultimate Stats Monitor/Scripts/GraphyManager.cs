...
namespace Tayx.Graphy
{
    ...
    public class GraphyManager : G_Singleton<GraphyManager>
    {
        ...
        [SerializeField] private Color m_monoRamColor2 = new Color(0.3f, 0.65f, 1f, 1);
        [SerializeField] private Color m_monoRamColor3 = new Color(0.3f, 0.65f, 1f, 1);
        ...
        private G_RpmManager m_rpmManager = null;
        ...
        public Color MonoRamColor2
        {
            get { return m_monoRamColor2; }
            set { m_monoRamColor2 = value; m_ramManager.UpdateParameters(); }
        }
        public Color MonoRamColor3
        {
            get { return m_monoRamColor3; }
            set { m_monoRamColor3 = value; m_ramManager.UpdateParameters(); }
        }
        ...
        public float MonoRam2 { get { return m_ramMonitor.MonoRam2; } }
        public float MonoRam3 { get { return m_ramMonitor.MonoRam3; } }
        ...
        public void Enable()
        {
            if (!m_active)
            {
                if (m_initialized)
                {
                    ...
                    m_rpmManager.RestorePreviousState();
        ...
        public void Disable()
        {
            if (m_active)
            {
                ...
                m_ramManager.SetState(ModuleState.OFF);
                m_rpmManager.SetState(ModuleState.OFF);
                m_audioManager.SetState(ModuleState.OFF);
                m_advancedData.SetState(ModuleState.OFF);
        ...
        private void RefreshAllParameters()
        {
            ...
            m_rpmManager.RefreshParameters();
